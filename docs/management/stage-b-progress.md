...
- [ADR-0004](./adrs/0004-task-authority-commit-recovery-owner.md) 已接受 TaskAuthority-owned worker；周期调度、退避/jitter、升级策略、metrics/运维 API 仍待实现与验证。
