...
| `B-SLICE-K` | Slice K：Package → Application → Task → Fiber → Operation → Receipt → 控制 | `READY` | [v0.5 Slice K](../design/06-架构设计总纲-v0.5.md) | 2026-08-29 决策批准立即全量并行启动：B-CONTROL/B-SANDBOX/Package 车道与地基收尾同跑；端到端贯通仍需前述执行、持久化、Process、权限和控制能力 |
