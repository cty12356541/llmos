...
| `B-SEMANTIC` | canonical SemanticEvent、签名、lineage、Admission/Durability 与 authority view | `IN_PROGRESS` | [B-SEMANTIC-001](../evidence/stage-b/b-semantic-001-durable-assertion-admission.md)：durable Assertion admission；[B-SEMANTIC-002A](../evidence/stage-b/b-semantic-002a-canonical-intent-spec-body.md)：canonical IntentSpec/Criterion/hard-set identity PARTIAL PASS | SpecEvent durable admission、Judgment/Verification/Retraction、declassification、batch DAG、Trust View/checkpoint、fault matrix |
