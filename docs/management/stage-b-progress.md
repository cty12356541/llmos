...
| `B-TASK-006M` | Recovery metrics export contract | `PARTIAL_PASS` | [B-TASK-006M](../evidence/stage-b/b-task-006m-recovery-metrics-export.md)：typed catalog 顺序/稳定名称、live authority snapshot 与 sink failure 短路；本地 2 项新增测试与三平台 + MSRV Rust CI [32614979438](https://github.com/cty12356541/llmos/actions/runs/32614979438)、Pages [32614979403](https://github.com/cty12356541/llmos/actions/runs/32614979403) 通过 | 具体 OpenMetrics/ETW/signpost adapter、scrape auth、retention/alert rules、生产 metrics sink |
