...
| `B-SEMANTIC` | canonical SemanticEvent、签名、lineage、Admission/Durability 与 authority view | `IN_PROGRESS` | [B-SEMANTIC-001](../evidence/stage-b/b-semantic-001-durable-assertion-admission.md)：deterministic-CBOR Assertion、EventId/content digest、Identity+Process+Capability gates、signed DURABLE AdmissionReceipt/outbox PARTIAL PASS | Judgment/Verification/Retraction/Spec payload、declassification、batch DAG、Trust View/checkpoint、fault matrix |
