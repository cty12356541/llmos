...
| Exit gate | 当前结论 |
|---|---|
| `ROAD-B-001` 第三方 Application 安装/更新/卸载 | 局部推进：install/disable/update 已有单节点 H3（[B-APPLICATION-001](../evidence/stage-b/b-application-001-installation-authority.md)、[B-APPLICATION-002](../evidence/stage-b/b-application-002-update.md)）；uninstall/rollback 与完整 `[PKG-UPDATE-001]` 生命周期策略未做 |
