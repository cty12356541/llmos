...
| W32-G | 各层 inspect 补齐（B5-3：TaskGroup/TaskNode、ExecutionFiber、Topic/Operation） | nlos-system-control | 每层 inspect Receipt 齐；§6 B-005 行更新 |
