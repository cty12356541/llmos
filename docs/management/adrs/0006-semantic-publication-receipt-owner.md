...
- 2026-08-19 后续切片 `B-TASK-008C2G-CROSS-TERM-ADOPTION` 在 schema v38 新增独立
  immutable adoption receipt 表，允许旧 `QUARANTINED` permit 在 completed takeover
  与 successor registry reopen 之后，沿 exact fence root/current assignment proof
  继续核心 reconcile/close/v3 terminal path；它不产生新的 EffectPermit，也不把
  本地证明提升为远端 cleanup/endpoint attestation。详见
  [Evidence](../../evidence/stage-b/b-task-008c2g-cross-term-adoption.md)。
