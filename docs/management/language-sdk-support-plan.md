...
| Durable idempotency authority + reconnect IPC | `PARTIAL PASS`，SQLite v3 三平台 run 30738888761 成功；TS/Python 真实断线重连本地通过，远程待复验 | `B-SCHEMA`、`B-STORE`、B-SCHEMA-010/011 |
