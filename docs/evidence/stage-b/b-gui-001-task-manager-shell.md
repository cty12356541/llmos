# B-GUI-001:可信 Tauri 任务管理器壳(W32-A 只读半 + W32-B 写入半 + W32-D 权限/预算可见)

> 状态:`PARTIAL PASS`(读半 W32-A + 写入半 W32-B + 权限/预算可见 W32-D 已落地;parity 钉死 W32-C 未做)
>
> 日期:2026-09-20(W32-A)/ 2026-09-21(§W32-B、§W32-D)
>
